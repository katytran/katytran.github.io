...
(function ($) {
  ...
  if ($(window).width() >= 992) {
    if (
      $(".header_wrap.sidebar_menu,.portfolio_modal .modal-content").length > 0
    ) {
      $(
        ".header_wrap.sidebar_menu,.portfolio_modal .modal-content"
      ).mCustomScrollbar({
        theme: "dark",
      });
    }
    ...
    if (
      $(".header_wrap .navbar-collapse, .portfolio_modal .modal-content")
        .length > 0
    ) {
      $(
        ".header_wrap .navbar-collapse, .portfolio_modal .modal-content"
  ...
  $(window).on("load", function () {
    ...
    $("#demo_content").load("http://google.com");
  });
})(jQuery);
